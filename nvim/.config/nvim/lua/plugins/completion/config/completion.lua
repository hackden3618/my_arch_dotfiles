...
function M.setup()
    ...
    npairs.setup({
        ...
        -- Don't fight the completion/navigation UI.
        disable_filetype = { "TelescopePrompt", "cmp_menu", "snacks_terminal" },

        -- Closing a pair with <CR> should not require re-pressing <CR>.
        map_cr = true,

        -- Intelligent fast-wrap: press <M-e> to cycle where the closing
        -- delimiter lands when wrapping an existing expression.
        fast_wrap = {
            map    = "<M-e>",
            chars  = { "(", "{", "[", '"', "'" },
