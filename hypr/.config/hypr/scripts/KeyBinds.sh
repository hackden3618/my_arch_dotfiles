...
keybinds_conf="$HOME/.config/hypr/hyprconf/configs/Keybinds.conf"
user_keybinds_conf="$HOME/.config/hypr/hyprconf/UserConfigs/UserKeybinds.conf"
laptop_conf="$HOME/.config/hypr/hyprconf/UserConfigs/Laptops.conf"
