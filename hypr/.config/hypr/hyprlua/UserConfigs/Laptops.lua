...
-- })
--
local touchpad_state = HOME .. "/.config/hypr/hyprlua/Generated/Touchpad.lua"
local touchpad_state_file = io.open(touchpad_state, "r")
if touchpad_state_file then
    touchpad_state_file:close()
    dofile(touchpad_state)
end
